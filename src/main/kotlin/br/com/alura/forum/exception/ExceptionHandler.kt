...
class ExceptionHandler {
    ...
    //quando a exception NotFound acontecer o spring vai chamar esse método
    ...
    fun handleValidationError(exception: MethodArgumentNotValidException, request: HttpServletRequest): ErrorView {
        ...
        exception.bindingResult.fieldErrors.forEach {
            //para cada erro encontrado, adiciona no map, a chave vai ser o campo e o valor vai ser a mensagem
